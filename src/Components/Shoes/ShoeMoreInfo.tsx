        ...
        <>
            ...
            <div className={s.moreInfo}>
                <div className={s.main}>
                    <img className={s.img} style={{height: "250px"}}
                         src={moreInfoShoe.media.imageUrl ? moreInfoShoe.media.imageUrl : "https://stockx-assets.imgix.net/media/New-Product-Placeholder-Default.jpg?fit=fill&bg=FFFFFF&w=700&h=500&auto=format,compress&trim=color&q=90&dpr=2&updated_at=0"}
                         alt={"sneaker"}/>
                    ...
                    <button disabled={moreInfoShoe.retailPrice === 0 || !moreInfoShoe.retailPrice}
                            onClick={() => addToCartById(moreInfoShoe.id)} style={{width: "100%", height: "50px"}}
                            className={"btn btn-outline-warning"}>Cart
                    </button>
                </div>
